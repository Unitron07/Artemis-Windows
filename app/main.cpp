...
LONG WINAPI UnhandledExceptionHandler(struct _EXCEPTION_POINTERS *ExceptionInfo)
{
    ...
    swprintf_s(dmpFileName, L"%ls\\Asteria-%I64u.dmp",
...
int main(int argc, char *argv[])
{
    ...
    QCoreApplication::setOrganizationName("Asteria Project");
    QCoreApplication::setOrganizationDomain("Unitron07.github.io");
...
#endif
    {
        s_LoggerFile = new QFile(tempDir.filePath(QString("Asteria-%1.log").arg(QDateTime::currentSecsSinceEpoch())));
    ...
    QStringList existingLogNames = tempDir.entryList(QStringList("Asteria-*.log"), QDir::NoFilter, QDir::SortFlag::Time);
    ...
    SDL_SetHint(SDL_HINT_AUDIO_DEVICE_APP_NAME, "Asteria");
    SDL_SetHint(SDL_HINT_APP_NAME, "Asteria");
    ...
    app.setDesktopFileName("io.github.Unitron07.Asteria");
    qputenv("SDL_VIDEO_WAYLAND_WMCLASS", "io.github.Unitron07.Asteria");
    qputenv("SDL_VIDEO_X11_WMCLASS", "io.github.Unitron07.Asteria");
